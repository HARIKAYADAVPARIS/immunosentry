      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            confidenceInterval: { type: Type.STRING, description: "e.g. +/- 5%" },
            featureImportance: {
              type: Type.ARRAY,
              items: {
                type: Type.OBJECT,
          ...
          required: ["riskScore", "survivalProbability", "riskLevel", "organsAtRisk", "analysis", "evidenceTrace", "featureImportance", "recommendations", "confidenceLevel", "confidenceInterval"]
        }
      },
    });

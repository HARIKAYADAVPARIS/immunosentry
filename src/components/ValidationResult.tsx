        ...
        <div className="mb-16 flex flex-col md:grid md:grid-cols-2 items-end justify-between gap-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-xl text-gray-500 leading-relaxed">
              We benchmarked ImmunoSentry against major genomic datasets and the <strong>GeRI Cohort (n=1,302)</strong>, specifically verifying our model's ability to predict <strong>early treatment cessation</strong> and patient dropout with high precision.
            </p>
          </div>

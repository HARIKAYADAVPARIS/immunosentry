...
import { ShieldCheck, Activity, Info, Briefcase, Database, BarChart3, Zap, Target, Globe, Menu, X, ArrowRight } from "lucide-react";
...
export function Header() {
  ...
  const navLinks = [
    ...
    { href: "#assessment", label: "Assessment", icon: <Activity className="w-4 h-4" />, type: "anchor" },
    { href: "#intervention-engine", label: "Timing Simulation", icon: <Zap className="w-4 h-4" />, type: "anchor" },

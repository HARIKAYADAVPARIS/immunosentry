              ...
              <div className="space-y-6">
                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                  <h4 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                    <BarChart3 className="w-4 h-4 text-indigo-600" /> Benchmark Methodology (Cross-Cohort)
                  </h4>
                  <p className="text-xs text-gray-600 leading-relaxed">
                    The cross-cohort benchmarked AUC 0.84 across MSK-IMPACT and TCGA datasets was achieved using an ensemble of Gradient Boosted Decision Trees (XGBoost/CatBoost). Features included clinical variables (Age, Gender, Tumor Grade, Charlson Index), HLA-B*27/DRB1*03 alleles, and microbial abundance. We utilized an 80/20 stratified train/test split with Bayesian hyperparameter optimization.
                  </p>
                </div>

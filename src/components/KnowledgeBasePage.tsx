...
const BIOMARKERS = [
  ...
  },
  {
    ...
    evidence: "Published clinical research findings have consolidated the role of AI in informing clinical decision-making for ICIs."
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex flex-col items-center justify-center gap-6 mb-8">
            <div className="flex items-center gap-3 opacity-50 mb-4">
              <img src="/logo.svg" alt="ImmunoSentry Logo" className="h-8 w-auto opacity-50 grayscale" referrerPolicy="no-referrer" />
            </div>

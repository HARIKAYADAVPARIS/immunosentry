...
export function RealWorldValidation() {
  ...
  return (
    <section id="real-world-validation" className="py-32 bg-white border-t border-gray-100">
        ...
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-xl text-gray-500 leading-relaxed">
              Cross-cohort benchmarked AUC 0.84 across MSK-IMPACT and TCGA datasets. Directly benchmark against real patient cohorts from cBioPortal, informed by ESMO TAT 2025 findings.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-gray-50/50 p-8 rounded-3xl border border-gray-100">
              <label className="block text-xs font-bold text-gray-400 uppercase mb-6 tracking-widest">Select Study Cohort</label>
              ...
              <div className="relative mb-6">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white border border-gray-100 rounded-2xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all font-medium"
                />
              </div>
            ...
            {selectedStudy && (
              <div className="bg-indigo-50 p-6 rounded-3xl border border-indigo-100">
                <h4 className="text-xs font-bold text-indigo-900 mb-2">Study Details</h4>
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <p className="mt-8 text-xs text-gray-400 leading-relaxed">
                      Consistent retrospective performance across tumor types and ICI regimens. All benchmarking performed on publicly available datasets via cBioPortal (Cerami et al. 2012). 
                      <span className="block mt-2 font-bold text-indigo-600">Prospective Technical Evaluation: Ongoing with Gustave Roussy prospective cohort.</span>
                    </p>
                  </div>
                </motion.div>
              )}
              ...
              {loading && (
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-gray-900">Fetching cBioPortal Data</h4>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                      <div className="flex items-center justify-between mb-8">
                        <h4 className="text-sm font-bold text-gray-900 uppercase tracking-widest">ROC Curve</h4>
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                      <div className="flex items-center justify-between mb-8">
                        <h4 className="text-sm font-bold text-gray-900 uppercase tracking-widest">Calibration Plot</h4>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-1 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                      <h4 className="text-sm font-bold text-gray-900 uppercase tracking-widest mb-8">Confusion Matrix</h4>
                        ...
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="mt-4 p-3 bg-white/5 rounded-xl border border-white/10">
                              <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest leading-none mb-1">Ongoing Evaluation</p>
                              <p className="text-[10px] text-gray-400 leading-tight">Technical evaluation ongoing with <strong>Gustave Roussy</strong> prospective cohort.</p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <p className="mt-8 text-xs text-gray-400 leading-relaxed">
                      Consistent retrospective performance across tumor types and ICI regimens. All validation performed on publicly available datasets via cBioPortal (Cerami et al. 2012). 
                      <span className="block mt-2 font-bold text-indigo-600">Technical evaluation ongoing with Gustave Roussy prospective cohort.</span>
                    </p>
                  </div>
                </motion.div>
              )}

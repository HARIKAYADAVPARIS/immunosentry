      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 text-xs font-bold uppercase tracking-wider mb-6">
            <Beaker className="w-3 h-3" /> Biological Simulation Sandbox
          </div>
          <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-6xl font-display">
            Cytokine <span className="text-indigo-600">Cascade Simulator</span>.
          </h2>
          <p className="mt-6 text-xl text-gray-500 max-w-3xl leading-relaxed">
            A mechanistic ODE-based engine that simulates T-cell activation and cytokine release following ICI administration. Predict the optimal window for steroid intervention without compromising anti-tumor efficacy.
          </p>
        </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-xs font-bold text-gray-900 uppercase tracking-widest">Biological Thresholds</h4>
                      <div className="group relative">
                        <Info className="w-3 h-3 text-gray-400 cursor-help" />
                        <div className="absolute bottom-full right-0 mb-2 w-48 p-2 bg-gray-900 text-[8px] text-white rounded shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20">
                          Parameters derived from human cytokine response benchmarks (ESMO TAT 2025).
                        </div>
                      </div>
                    </div>
                    <div className="space-y-3">
                  ...
                  <div className="bg-amber-50 p-6 rounded-3xl border border-amber-100">
                    <div className="flex items-center gap-2 text-xs font-bold text-amber-800 uppercase mb-4">
                      <Scale className="w-4 h-4" /> Technical Guardrails
                    </div>
                    <div className="space-y-3">
                      <div className="text-[10px] text-amber-700 leading-relaxed">
                        <span className="font-bold">Model Bias Adjustment:</span> Currently weighted for NSCLC/Melanoma cohorts. Predictive power for Hematologic malignancies is not yet validated.
                      </div>
                      <div className="text-[10px] text-amber-700 leading-relaxed">
                        <span className="font-bold">Assumptions:</span> Linear accumulation of tissue damage; ignores compensatory anti-inflammatory cytokine feedback loops (IL-10).
                      </div>
                    </div>
                  </div>
